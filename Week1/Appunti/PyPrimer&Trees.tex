...
Linked Binary Tree è un'implementazione concreta, quindi per il codice dei vari metodi riportati in foto guarda il file Week1/Trees/LinkedBinaryTree.py

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Immagini/PerformanceLinkedBinaryTree.png}
    \caption{Linked Binary Tree}
\end{figure}
